...
<div data-role="page" id="two" data-add-back-btn=true data-ajax="false">
 ...
 <li data-role=list-divider>Patient List</li>
		
	   <c:forEach items="${persons}" var="person">
	    
	  	 <li>
        <a href="recordContents?callCompleteDtm=${person.callCompleteDtm}" data-transition="slide" >  <img src= "../resources/images/p-logo.png" class=ui-li-icon /> <c:out value="${person.patientName}" /></a>
      	</li>
      </c:forEach>         
